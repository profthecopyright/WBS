...
export const proProfiles: ProProfile[] = [
  {
    ...
    paragraphs: [
      "Brian Glubok founded World Bridge Services to give his tournament and online clients access to trusted professional partners, even when he could not be at the table himself. He remains closely involved in matching clients with professionals and guiding the agency.",
      ...
      "Brian brings that experience to tournament partnerships, online play, and personal coaching. Away from the table, he writes Diary of a Bridge Pro and pursues his interests in writing, filmmaking, and painting. As his friends like to remind him, he is a bridge player above all."
    ],
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "An enthusiastic competitor at many sports, Joe brings the same appetite for the game to his WBS partnerships. He plays regularly for agency clients online, fitting sessions around a busy international tournament schedule."
    ],
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "For WBS clients, Finn offers the chance to develop a partnership with a player whose international career is already distinguished and still unfolding."
    ],
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "His advanced academic training in marine biology and work as a Portuguese translator complement a thoughtful approach to instruction. Paulo enjoys helping students understand both declarer play and defense, with attention to the decisions that make a difference at the table.",
  ...
  },
  {
    ...
    paragraphs: [
      "Gregor Rus is a university professor at the Faculty of Mathematics and Physics, University of Ljubljana, and an accomplished member of the Slovenian bridge team. His experience as a teacher extends across bridge and academic subjects, with something to offer players at every level.",
  ...
  },
  {
    ...
    paragraphs: [
      "Ljudmila Kamenova received her PhD from MIT in 2006, spent the following year at the Institute for Advanced Study in Princeton, and has since been a faculty member at Stony Brook University. Her mathematical research is in complex differential geometry.",
      "Her bridge record includes the 2004 Collegiate Championship, consecutive Women's Board-a-Match titles in 2017 and 2018, the 2021 USBF Mixed trials as USA2, and the 2023 Fast Pairs. She was also Long Island Player of the Year in 2016 and has several major national runner-up finishes.",
      "Ljudmila welcomes enquiries about future professional partnerships, including women's and mixed events. Her academic and family commitments mean that arrangements are made around her schedule."
    ],
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "A professional speaker with a longstanding enthusiasm for technology, Ed is helping WBS develop its online teaching program. His instruction is intended for developing players who want to build sound habits and become more confident at the table.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "His cheerful, good-natured manner makes him an approachable partner, while his competitive focus remains firmly on the game. WBS clients can enquire about club and online partnerships suited to their goals and schedules."
    ],
...
export function requestHref(pro?: ProProfile, service?: string) {
  const params = new URLSearchParams();
  if (pro) params.set("pro", pro.slug);
