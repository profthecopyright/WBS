...
These recruits have not been added to the public roster. Confirm their agreement to be featured and their preferred biography and portrait first.

## Keith Hafen

Virginia-based bridge teacher, club director, playing professional, and occasional cruise host. Brian met Keith at the September 2026 Rhode Island regional and highlighted his strong bridge and people skills. Prospective clients should be matched through the WBS scheduling office.

Confirm participation, playing formats, current event eligibility, and an approved portrait before publication.

## Shannon Cappelletti

Experienced playing professional who worked with WBS clients in 2021 or 2022. Brian invited Shannon to join the featured roster on September 9, 2026; her confirmation has not been supplied.
...
Ljudmila explicitly approved featuring her and using a portrait from her university webpage. The image credit is Archives of the Mathematisches Forschungsinstitut Oberwolfach.

## Editorial Follow-Up

- Confirm Danuta's exact 2026 championship and client details before expanding that claim.
- Confirm Ed's class launch, timetable, and registration arrangements before advertising a scheduled class.
- Preserve Bob's existing WBS exclusivity badge; his fuller profile also explains limited availability.
...
Meow approved the existing AI-assisted appearance and requested a level forward-facing head position and slightly thinner facial contours. This is an AI-edited portrait, not an untouched documentary crop. The earlier version remains available. His biography uses Meow in the second and third paragraphs, while the opening establishes his legal name, Hongbo Li.

Prepared with the built-in image editing tool. Final refinement prompt:

Use case: identity-preserve. Edit target: the attached current WBS portrait of Hongbo Li, who goes by Meow. This is an authorized edit requested by the subject. Make ONLY two subtle adjustments to the man wearing black rectangular glasses and the black bridge T-shirt: (1) lower his chin slightly to a natural, level frontal head position, with his eyes looking straight ahead horizontally at eye level instead of upward; (2) make his face just a little thinner through restrained cheek and jawline slimming. Preserve his recognizable identity, age, ethnicity, eye shape, glasses, hairstyle, nose, lips, facial hair, skin texture, relaxed closed-mouth expression, and the existing natural photographic appearance. Keep face proportions realistic; no drastic weight change, gauntness, exaggerated jawline, skin smoothing, or glamour makeover. Preserve the exact portrait framing and vertical 4:5 aspect ratio, original blue ACBL background and its white logos, neighboring person's grey sleeve and arm, black shirt with its bridge text and symbols, medal ribbon, hands, bidding card, photographic lighting and colors. Do not add or remove objects, change or redraw the lettering, or change anything outside the subtle head-position and facial-width adjustments.

### Original Crop

Prepared with the built-in image editing tool. Original crop prompt:

Use case: identity-preserve. Asset type: authentic WBS profile photograph. Edit target: the attached original 2048x1504 group photograph. The user is the last / rightmost person: the East Asian man with black rectangular glasses, dark short hair, a black bridge T-shirt, a medal ribbon, holding a bidding card. Primary request: ONLY CROP this existing photograph to a vertical 4:5 head-and-upper-chest portrait of that rightmost person, with modest space above his hair. Keep all his facial features, expression, glasses, pose, clothing, the neighboring arm on his shoulder, original blue ACBL backdrop, and original photographic pixels and lighting unchanged. Do not generate a different portrait, retouch or beautify him, redraw or change text, reconstruct any missing pixels, replace or extend the background, remove objects, or add any new content. Crop only: roughly the original-image rectangle x=1360 to 1840 and y=245 to 845 (480x600). The other three people's faces must be outside the crop. Preserve the exact real person from the source photo.
