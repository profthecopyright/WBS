...
for (const meaning of ['2020 lockdown', 'Alex Kolesnik, Joe Grue, and Ron Smith', 'coach and counsel', "agency's first three years", 'stealing our masterpoints', 'professionals playing alongside sponsors', 'outlives its founders']) assert.ok(currentPage.includes(meaning));
